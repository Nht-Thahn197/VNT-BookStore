						...
						<div class="col-md-8">
							<form role="form" method="post" action="index.php?controller=user&action=store">
								<div class="form-group">
									<label>Tên</label>
									<input name="user_name" required class="form-control" type="text">
								</div>
								<div class="form-group">
									<label>Email</label>
									<input name="user_email" required class="form-control" type="email">
								</div>
								<div class="form-group">
									<label>Mật khẩu</label>
									<input name="user_pass" required class="form-control" type="password">
								</div>
